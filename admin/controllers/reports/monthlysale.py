...
from datalayer.appservice.admin.reports.sale import SaleByMonth
...
class MonthlySale(BaseHandler):
    def get(self):
        ...
        template_values = {
                           'title': 'Agent Monthly Sale',
                           'today': DateTime.to_date_string(DateTime.malaysia_today()),
                           'current_user': current_user,
                           'users': users
                           }
        
        template = JINJA_ENVIRONMENT.get_template('report/salebydaymonth.html')
    ...
    def post(self):
        ...
        try:
            ...
            values = sale_by_month.get(date_from, date_to)
