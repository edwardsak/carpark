...
class MonthlyAttendantCharge(BaseHandler):
    def get(self):
        ...
        template_values = {
                           'title': 'Monthly Charge By Attendant',
                           'today': DateTime.to_date_string(DateTime.malaysia_today()),
                           'current_user': current_user,
                           'users': users
                           }
        
        template = JINJA_ENVIRONMENT.get_template('reports/chargebymonthandattendant.html')
